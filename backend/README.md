...
## Project Structure
    ...
    ├── juanconnectorsbaseapi_1  # Django project configurations
...
1. Clone this repo and `cd juanconnectorsbaseapi_1`
...
2. Clone this repo and `cd juanconnectorsbaseapi_1`
