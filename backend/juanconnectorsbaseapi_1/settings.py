"""
Django settings for juanconnectorsbaseapi_1 project.
...
ROOT_URLCONF = 'juanconnectorsbaseapi_1.urls'
...
WSGI_APPLICATION = 'juanconnectorsbaseapi_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juanconnectorsbaseapi_1 API",
    "DESCRIPTION": "API documentation for juanconnectorsbaseapi_1 App",
    "VERSION": "v1",
}
